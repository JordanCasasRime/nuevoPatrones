        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="font-size: 25px;">Editar Usuario</h2>
                            ...
                            <form class="forms-sample" action="UsersController" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nombreUser" name="nombreUser" value="${persona.name}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="apellidosUser" class="col-sm-2 col-form-label">Apellidos :</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="apellidosUser" name="apellidosUser" value="${persona.lastName}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="edadUser" class="col-sm-2 col-form-label">Edad :</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="edadUser" name="edadUser" value="${persona.age}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="direccionUser" class="col-sm-2 col-form-label">Dirección :</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="direccionUser" name="direccionUser" value="${persona.address}">
                                    </div>
                                </div>
                                <div class="form-group row">
